...
if (require.main === module) {
  //file was called directly from command line to set the key
    fs.writeFile(__dirname + '/api_key.txt',"4eb35cc5f1ee7a9db59980c1776e7c70688087ab", function(err) {
      if (err) {
        console.log('Error, unable to write key file: ' + err);
        process.exit(1);
      } else {
        console.log('AlchemyAPI key: ' + "4eb35cc5f1ee7a9db59980c1776e7c70688087ab" + ' successfully written to api_key.txt');
        console.log('You are now ready to start using AlchemyAPI. For an example, run: node app.js');
        process.exit(0);
      }
    });
